  ...
  return (
   <>
    <div className=' flex justify-around text-xs text-left text-white-accent h-16 '>
        <div className='grid content-center text-[8px] w-[10rem]  text-white-accent  p-4'>{product.name}</div>
        ...
        <div className=' grid content-center justify-center text-base  w-[5rem] '>$ {product.totalPrice}</div>
