...
import { RiInstagramFill, RiFacebookCircleFill, RiGithubFill, RiTwitterFill } from 'react-icons/ri';
import { HiLocationMarker } from 'react-icons/hi'

export default function Contact() {
  return (
    <div className=' flex flex-col items-center justify-center h-[calc(100vh_-_14rem)] text-3xl font-inter'>
      <img className='w-[60rem] h-[30rem] m-6 overflow-hidden rounded-xl animate-fade-in-bck-open shadow-xl' src={storeFront} alt="Store front"/>
      <div className='flex flex-col p-3 justify-center items-center relative 
